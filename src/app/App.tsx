      ...
      <nav className={`fixed top-0 left-0 right-0 z-40 transition-all duration-700 ${
        ...
        <div className="max-w-[1600px] mx-auto px-6 lg:px-12">
          <div className="flex items-center justify-between h-24">
            ...
            {/* Menu Derecha */}
            <div className="hidden lg:flex items-center gap-8">
              {['Galería', 'Contacto'].map((item, idx) => (
                <motion.a
                  key={item}
                  href={`#${item === 'Contacto' ? 'ubicación' : item.toLowerCase()}`}
                  initial={{ opacity: 0, y: -10 }}
                  animate={{ opacity: 1, y: 0 }}
        ...
        <div className="max-w-[1200px] mx-auto">
          <div className="grid lg:grid-cols-4 gap-12 mb-12">
            <div className="lg:col-span-2">
              <div className="mb-4">
                ...
                <div className="flex items-center gap-2">
                  <div className="h-[1px] w-8 bg-[#D4AF37]" />
                  <span className="text-[#D4AF37] text-[8px] tracking-[0.3em]">EST. 1888</span>
                </div>
              </div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm">
                {['Inicio', 'Servicios', 'Membresías', 'Galería'].map((link) => (
                  <li key={link}>
                    <a
          ...
          <div className="border-t border-white/10 pt-8 text-center">
            <p className="text-white/30 text-xs">
              &copy; 2026 BÁRBAROS CLUB 1888. Todos los derechos reservados.
            </p>
          </div>
        </div>
      </footer>
